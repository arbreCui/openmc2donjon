"""Write OpenMC XML inputs for the hex minicase example."""
...
from hex_model import RunSettings, export_openmc_xml
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--case-dir",
        type=Path,
        default=Path("openmc_hex_minicase"),
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"wrote OpenMC hex minicase XML: {args.case_dir.resolve()}")
    print(
        "statepoint target: "
