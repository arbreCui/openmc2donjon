"""Write continuous-energy OpenMC XML for the IRENA SPH Stage 1 assembly."""
...
from irena_hex_sph_model import RunSettings, export_ce_xml
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"wrote IRENA SPH Stage 1 CE case: {args.case_dir}")
    return 0
